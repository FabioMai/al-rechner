export default function Home() {
  return (
    ...
    <meta
      name="description"
      content="Cedo is a landing page template built with Bootstrap 4 and HTML for loans and credit businesses with illustrative design which conveys simplicity and accessibility."
    />
