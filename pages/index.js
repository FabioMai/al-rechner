          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card">
                ...
                />
                <div class="card-body">
                  <h4 class="card-title">Kleinteilige Ackerbewirtschaftung</h4>
                  <p>XXX</p>
                  <div class="form-group">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p>
                    The family can't fit anymore in that one bedroom flat?
                    Change their lives with a nice new and modern home
                  </p>
                  <a
                    class="btn-solid-reg popup-with-move-anim"
                    href="#lightbox-3"
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p>
                    Have you decided to invest in your education and can't
                    afford the costs? Use the student loan for this purpose
                  </p>
                  <a
                    class="btn-solid-reg popup-with-move-anim"
                    href="#lightbox-4"
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <p>
                It's time to change that old rust bucket you're currently
                driving. Apply for a vehicle loan and enjoy the car of your
                dreams.
              </p>
              <ul class="list-unstyled li-space-lg">
                <li class="media">
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <p>
                ...
                the costs? Use the student loan for a better future.
              </p>
              <ul class="list-unstyled li-space-lg">
                <li class="media">
                  <i class="fas fa-check"></i>
            ...
            <div class="col-lg-12">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a class="btn-solid-reg page-scroll" href="#header">
                    Quote
                  </a>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p>up to</p>
                  <p class="price">
                    <span class="currency">$</span>25000
                  </p>
                  <hr class="cell-divide-hr" />
                  <ul class="list-unstyled li-space-lg">
                    <li class="media">
            ...
            <div class="col-lg-6">
              <div class="tabs-container">
                ...
                <div class="tab-content" id="cedoTabsContent">
                  ...
                  >
                    <p>
                      It's very easy to obtain a loan quotation. You just need
                      to fill out the
                      <a class="white page-scroll" href="#header">
                        Get Quote Form
                      </a>
                      and one of our Credit Counselors will call to assist you
                      in less than 24 hours.
                    </p>
                    <p>
                      You will need to provide some personal details so please
                      make sure you read our terms & conditions and privacy
                      pages.
                    </p>
                    <a
                  ...
                  >
                    ...
                    <ul class="list-unstyled li-space-lg">
                      ...
                      <li class="media">
                        <i class="fas fa-check"></i>
                        <div class="media-body">
                          <strong>Kind</strong> staff including sympathetic
                          credit counselors
                        </div>
                      </li>
                      <li class="media">
